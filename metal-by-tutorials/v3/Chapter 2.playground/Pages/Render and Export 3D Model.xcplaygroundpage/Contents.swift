...
// EXPORT MESH EXAMPLE
// To perform this block without errors you need create
// "Shared Playground Data" folder inside your Documents
// folder. This "Shared Playground Data" is in the global
// constant - playgroundSharedDataDirectory
let asset = MDLAsset()
asset.add(mdlMesh)
